...
This system call is used to read data from an open file (identified by \texttt{fileDescriptor}) to the memory (identified by \texttt{memory\_loc}). The return value of the \texttt{Read()} system call is the number of words successfully read from the file or -1 otherwise. It calls Interrupt 3 Routine. \\
...
the number of words successfully written to the file or -1 otherwise. It calls Interrupt 4 Routine. \\
